...
struct ContentView: View {
    ...
    let labels = [
        "Estonia": "Флаг с тремя горизонтальными полосами: верхняя синяя, средняя черная, нижняя белая",
        "France": "Флаг с тремя вертикальными полосами: левая синяя, средняя белая, правая красная",
        "Germany": "Флаг с тремя горизонтальными полосами: верхняя черная, средняя красная, нижняя золотая",
        "Ireland": "Флаг с тремя вертикальными полосами: левая зеленая, средняя белая, правая оранжевая",
        "Italy": "Флаг с тремя вертикальными полосами: левая зеленая, средняя белая, правая красная",
        "Nigeria": "Флаг с тремя вертикальными полосами: левая зеленая, средняя белая, правая зеленая",
        "Poland": "Флаг с двумя горизонтальными полосами: верхняя белая, нижняя красная",
        "Spain": "Флаг с тремя горизонтальными полосами: верхняя красная, средняя желтая, нижняя красная",
        "UK": "Флаг с пересекающимися красными и белыми крестами прямыми и диагональными на синем фоне",
        "Russia": "Флаг с тремя горизонтальными полосами: верхняя белая, средняя синяя, нижняя красная",
        "US": "Много красных и белых полос с белыми звездами на синем фоне в левом верхнем углу",
    ]
